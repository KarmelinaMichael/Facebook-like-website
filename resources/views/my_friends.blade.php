 ...
 <!--  <table style="width:100%">
    ...
    <table style="width:100% cellspacing=0px;cellpading=0px;">
      @foreach ($friends as $friend)
          ...
          <tr><a class="name" href="/profile/{{ $friend->User_id }}"><h3>{{ $friend->Firstname }} {{ $friend->Lastname }}</h3></a></tr>
          <tr><img  src="/Downloads/{{$friend->Image_path}}"alt="profilepicture" style="width:350px;
                                  height:300px;margin-bottom: 60px;margin-top: 10px;"
                                  class="img-responsive"></tr>
          <tr><a class="btn btn-primary" href="/delete_friend_request/{{$friend->User_id}}">Delete Friend</a></tr>
